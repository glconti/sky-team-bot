...
public class ConcentrationModuleTests
{
    ...
    public void GetAvailableCommands_ShouldYieldNone_WhenSlotsAreFull()
    {
        ...
        // Act
        var pilotCommands = module.GetAvailableCommands(Player.Pilot, [BlueDie.FromValue(1)], [], new()).ToArray();
        var copilotCommands = module.GetAvailableCommands(Player.Copilot, [], [OrangeDie.FromValue(1)], new()).ToArray();
