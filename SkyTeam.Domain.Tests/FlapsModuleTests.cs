...
public class FlapsModuleTests
{
    ...
    public void GetAvailableCommands_ShouldYieldOnlyAllowedDistinctValues_ForNextSwitch_WhenCopilotTurn()
    {
        ...
        // Act
        var commands = module.GetAvailableCommands(Player.Copilot, [], unusedOrangeDice, new()).ToArray();
    ...
    public void GetAvailableCommands_ShouldBeEmpty_WhenCurrentPlayerIsNotCopilot()
    {
        ...
        // Act
        var commands = module.GetAvailableCommands(Player.Pilot, [], unusedOrangeDice, new()).ToArray();
    ...
    public void GetAvailableCommands_ShouldBeEmpty_WhenNoUnusedOrangeDice()
    {
        ...
        // Act
        var commands = module.GetAvailableCommands(Player.Copilot, [], [], new()).ToArray();
    ...
    public void GetAvailableCommands_ShouldBeEmpty_WhenAllSwitchesActivated()
    {
        ...
        // Act
        var commands = module.GetAvailableCommands(Player.Copilot, [], [OrangeDie.FromValue(6)], new()).ToArray();
